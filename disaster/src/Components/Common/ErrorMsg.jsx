...
export const ErrorMsg = () => {
  ...
  return (
    ...
    <div className="flex flex-col gap-3 justify-center items-center w-full h-[600px]">
        ...
        <p className="text-lg text-accent max-w-screen-sm text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis pariatur eos error cum odit quidem aliquam, quam molestias maxime, enim ex culpa adipisci, fugit nobis! Quod rem reiciendis sunt? Impedit.</p>
